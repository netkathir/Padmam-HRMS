@extends('layouts.app')
@section('title','Add Deduction Component')
@section('page-title','Add Deduction Component')
@section('page-subtitle','Define a new salary deduction head')
@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('masters.deductions.store') }}" method="POST">
            @csrf
            <div class="row g-3">
                <div class="col-md-5">
                ...
                <div class="col-md-4">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                        ...
                        <option value="statutory"  {{ old('type') == 'statutory'  ? 'selected' : '' }}>Statutory</option>
                    </select>
                    @error('type')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Calculation Base</label>
                    <input type="text" name="calculation_base" class="form-control" value="{{ old('calculation_base') }}" placeholder="e.g. gross">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-12">
                    <div class="form-check">
                        ...
                        <input type="checkbox" name="is_statutory" class="form-check-input" value="1" {{ old('is_statutory') ? 'checked' : '' }}>
