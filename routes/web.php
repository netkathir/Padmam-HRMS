...
Route::middleware(['auth', 'force.password.change', 'require.branch'])->group(function () {
    ...
    // the actual upload page.
    Route::get('/employee-document',        [EmployeeDocumentController::class, 'index'])->name('employee-document.index')->middleware('permission:employees.read');
    Route::get('/employee-document/create', [EmployeeDocumentController::class, 'create'])->name('employee-document.create')->middleware('permission:employees.create');
    Route::get('/employee-document/{employee}', [EmployeeDocumentController::class, 'show'])->name('employee-document.show')->middleware('permission:employees.read');
