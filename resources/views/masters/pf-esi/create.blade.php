        ...
        <form action="{{ route('masters.pf-esi.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="pf_employee_percent" step="0.01" min="0" max="100" class="form-control @error('pf_employee_percent') is-invalid @enderror" value="{{ old('pf_employee_percent', 12) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="pf_employer_percent" step="0.01" min="0" max="100" class="form-control @error('pf_employer_percent') is-invalid @enderror" value="{{ old('pf_employer_percent', 12) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="pf_ceiling" min="0" step="100" class="form-control @error('pf_ceiling') is-invalid @enderror" value="{{ old('pf_ceiling', 15000) }}" required>
                ...
                <div class="col-md-3">
                    <label class="form-label">Employee Contribution % <span class="text-danger">*</span></label>
                    <input type="number" name="esi_employee_percent" step="0.01" min="0" max="100" class="form-control @error('esi_employee_percent') is-invalid @enderror" value="{{ old('esi_employee_percent', 0.75) }}" required>
                    @error('esi_employee_percent')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label">Employer Contribution % <span class="text-danger">*</span></label>
                    <input type="number" name="esi_employer_percent" step="0.01" min="0" max="100" class="form-control @error('esi_employer_percent') is-invalid @enderror" value="{{ old('esi_employer_percent', 3.25) }}" required>
                    @error('esi_employer_percent')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label">Wage Ceiling (₹) <span class="text-danger">*</span></label>
                    <input type="number" name="esi_ceiling" min="0" step="100" class="form-control @error('esi_ceiling') is-invalid @enderror" value="{{ old('esi_ceiling', 21000) }}" required>
