...
@section('page-subtitle','Define a new salary slab\'s PF/ESI/TDS configuration')
@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('masters.salary-slabs.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="salary_from" class="form-control @error('salary_from') is-invalid @enderror" value="{{ old('salary_from') }}" min="0" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="salary_to" class="form-control @error('salary_to') is-invalid @enderror" value="{{ old('salary_to') }}" min="0" required>
                            ...
                            <div class="col-md-6">
                                <select name="earnings[{{ $i }}][component_id]" class="form-select">
                                    ...
                                    @foreach($earningsComponents as $ec)
                                        <option value="{{ $ec->id }}" {{ (string) old("earnings.$i.component_id") === (string) $ec->id ? 'selected' : '' }}>{{ $ec->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <input type="number" step="0.01" name="earnings[{{ $i }}][value]" class="form-control" placeholder="%" min="0" max="100" value="{{ old("earnings.$i.value") }}">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" name="tds_percentage" class="form-control @error('tds_percentage') is-invalid @enderror" value="{{ old('tds_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" name="pf_employee_percentage" class="form-control @error('pf_employee_percentage') is-invalid @enderror" value="{{ old('pf_employee_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" name="pf_employer_percentage" class="form-control @error('pf_employer_percentage') is-invalid @enderror" value="{{ old('pf_employer_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" name="esi_employee_percentage" class="form-control @error('esi_employee_percentage') is-invalid @enderror" value="{{ old('esi_employee_percentage') }}" min="0" max="100" required>
