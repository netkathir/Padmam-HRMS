@extends('layouts.app')
@section('title', 'Contractor Attendance - ' . $contractor->name)
@section('page-title', 'Contractor Attendance')
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-4">No attendance records found for this
                                    contractor.</td>
                            </tr>
                        @endforelse
                    </tbody>
