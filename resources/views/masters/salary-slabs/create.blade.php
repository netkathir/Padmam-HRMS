...
@section('page-subtitle','Define a new salary band — the single source of truth for employee salary')
@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('masters.salary-slabs.store') }}" method="POST" id="salarySlabForm">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">Slab Name</label>
                    <input type="text" id="slabNamePreview" class="form-control" value="" disabled>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="min_ctc" name="min_ctc" class="form-control @error('min_ctc') is-invalid @enderror" value="{{ old('min_ctc') }}" min="0" step="1000" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="max_ctc" name="max_ctc" class="form-control @error('max_ctc') is-invalid @enderror" value="{{ old('max_ctc') }}" min="0" step="1000" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" id="tds_percentage" name="tds_percentage" class="form-control @error('tds_percentage') is-invalid @enderror" value="{{ old('tds_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" id="pf_employee_percentage" name="pf_employee_percentage" class="form-control @error('pf_employee_percentage') is-invalid @enderror" value="{{ old('pf_employee_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" id="pf_employer_percentage" name="pf_employer_percentage" class="form-control @error('pf_employer_percentage') is-invalid @enderror" value="{{ old('pf_employer_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" id="esi_employee_percentage" name="esi_employee_percentage" class="form-control @error('esi_employee_percentage') is-invalid @enderror" value="{{ old('esi_employee_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" id="esi_employer_percentage" name="esi_employer_percentage" class="form-control @error('esi_employer_percentage') is-invalid @enderror" value="{{ old('esi_employer_percentage') }}" min="0" max="100" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" min="0" id="basic_salary" name="basic_salary" class="form-control @error('basic_salary') is-invalid @enderror" value="{{ old('basic_salary') }}" required>
