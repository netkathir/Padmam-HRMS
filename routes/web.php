...
Route::middleware('auth')->group(function () {
    ...
    // Contract Labour Assignment
    Route::get('/contract-labour', [\App\Http\Controllers\Masters\ContractorController::class, 'contractLabourIndex'])->name('contract-labour.index');
