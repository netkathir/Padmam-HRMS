...
@section('page-subtitle', 'Monthly payroll management')

@section('page-actions')
    <a href="{{ route('payroll.generate') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Generate Payroll</a>
@endsection
                    ...
                    <tbody>
                        @forelse($records as $pr)
                            <tr>
                                ...
                                <td>₹{{ number_format($pr->basic, 0) }}</td>
                                <td>₹{{ number_format($pr->gross_salary, 0) }}</td>
