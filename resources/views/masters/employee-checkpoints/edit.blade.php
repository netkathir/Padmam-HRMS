        ...
        <form action="{{ route('masters.employee-checkpoints.update', $employeeCheckpoint) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="checkpoint_id" id="checkpoint_id" class="form-select @error('checkpoint_id') is-invalid @enderror" data-searchable required>
                        ...
                        @foreach ($checkpoints as $cp)
                            <option value="{{ $cp->id }}" data-code="{{ $cp->code }}" {{ old('checkpoint_id', $employeeCheckpoint->checkpoint_id) == $cp->id ? 'selected' : '' }}>{{ $cp->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    {{-- Numeric-only — see create.blade.php's comment for why. --}}
                    <div class="input-group">
                        ...
                        <input type="text" inputmode="numeric" pattern="[0-9]+" maxlength="20"
                            ...
                            value="{{ old('emp_checkpoint_id', $employeeCheckpoint->emp_checkpoint_id) }}" required>
                    </div>
