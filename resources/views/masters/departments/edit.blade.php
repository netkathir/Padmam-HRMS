        ...
        <form action="{{ route('masters.departments.update', $department) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" name="value_per_day" class="form-control @error('value_per_day') is-invalid @enderror" value="{{ old('value_per_day', $department->value_per_day) }}">
